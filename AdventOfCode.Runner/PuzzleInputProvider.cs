...
public sealed class PuzzleInputProvider
{
    ...
    private PuzzleInputProvider()
    {
        ...
        _httpClient = new HttpClient(
            new HttpClientHandler { CookieContainer = cookieContainer, AutomaticDecompression = DecompressionMethods.All, })
        {
            BaseAddress = baseAddress,
            DefaultRequestHeaders = { { "User-Agent", ".NET/9.0 (https://github.com/viceroypenguin/adventofcode by stuart@turner-isageek.com)" }, },
        };
    }
